...
ax_total.set_title('Comparison of Total Value of Skill Extraction Methods (CS vs IS)')
...
ax_avg.set_title('Comparison of Average Value of Skill Extraction Methods (CS vs IS)')
